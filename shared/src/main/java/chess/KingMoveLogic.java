...
//        // Up
//        if (onBoard(startPositionRow + 1, startPositionCol)) {
//            ChessPosition goodPosition = new ChessPosition(startPositionRow + 1, startPositionCol);
//            ChessMove goodMove = new ChessMove(myPosition, goodPosition, null);
//            if (!friendlyFire(board, goodPosition, myPiece)) {
...
//
//        // Left
//        if (onBoard(startPositionRow, startPositionCol - 1)) {
//            ChessPosition goodPosition = new ChessPosition(startPositionRow, startPositionCol - 1);
//            ChessMove goodMove = new ChessMove(myPosition, goodPosition, null);
//            if (!friendlyFire(board, goodPosition, myPiece)) {
//                validMoves.add(goodMove);
//            }
...
//
//        // Up and left
//        if (onBoard(startPositionRow + 1, startPositionCol - 1)) {
//            ChessPosition goodPosition = new ChessPosition(startPositionRow + 1, startPositionCol - 1);
//            ChessMove goodMove = new ChessMove(myPosition, goodPosition, null);
//            if (!friendlyFire(board, goodPosition, myPiece)) {
//                validMoves.add(goodMove);
//            }
